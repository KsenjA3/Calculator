...
// 2(7+(2*+8%
        assertEquals("2", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getStrPersentFrom().replaceAll(" ",""));
        assertEquals("+", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getNameSign().replaceAll(" ",""));
        assertEquals("8", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getCountNumber());

        assertEquals("2*(7+", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getStrBeforePersent().replaceAll(" ",""));
...
//2+8+(9-(2-5)-(2+8)%
        assertEquals("9-(2-5)", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getStrPersentFrom().replaceAll(" ",""));
        assertEquals("-", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getNameSign().replaceAll(" ",""));
        assertEquals("10", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getCountNumber());
        assertEquals("2+8+", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getStrBeforePersent().replaceAll(" ",""));
...
// 2(2+(7+3)+(2*+8%
        ...
        assertEquals("+", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getNameSign().replaceAll(" ",""));
        assertEquals("8", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getCountNumber());
        assertEquals("2*(2+(7+3)+", panelKey.buttonsEngineer.calculateCurrent.calculateBasic.getStrBeforePersent().replaceAll(" ",""));
